...
def main():
    ...
    parser.add_argument('--duration', type=int, default=60, help="Duration in seconds to publish ticks.")
    ...
    parser.add_argument('--channel', type=str, default=REDIS_CHANNEL, help="Redis channel to publish to.")
    ...
    print(f"Starting tick publisher for {args.duration} seconds. Publishing to channel '{args.channel}'.")
    ...
    try:
        while running and time.time() < end_time:
            ...
            tick_message = {
                ...
                "close": round(100.0 + (random.random() * 10 - 5), 2) # Add some minor price variation
            }
