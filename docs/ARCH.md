<!-- AUTOGENERATED-SECTIONS:keep -->
# Architecture v2 Description

This document describes the core components and interactions of the v2 architecture.
The diagram below (`arch_v2.drawio.svg`) visualises these relationships.

![Architecture Diagram](arch_v2.drawio.svg)
...
5.  **Orchestrator ([osiris_policy/orchestrator.py](../osiris_policy/orchestrator.py)):**
...
6.  **LanceDB** (data in [`lancedb_data/`](../lancedb_data)):
...
### Telemetry & GPU selector toggles
